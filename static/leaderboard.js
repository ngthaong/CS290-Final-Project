...
templates['leaderboard'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return " <li class = \"leaderboard names\">"
    ...
    + " = "
    + alias4(((helper = (helper = lookupProperty(helpers,"wins") || (depth0 != null ? lookupProperty(depth0,"wins") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"wins","hash":{},"data":data,"loc":{"start":{"line":1,"column":44},"end":{"line":1,"column":52}}}) : helper)))
    + " wins</li> ";
},"useData":true});
})();